...
interface PaperAirplaneIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}
...
const PaperAirplaneIcon = forwardRef<PaperAirplaneIconHandle, PaperAirplaneIconProps>(
