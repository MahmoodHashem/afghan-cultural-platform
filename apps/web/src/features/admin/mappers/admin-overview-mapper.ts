...
const activityMetadata: Record<AdminAuditAction, { label: string; tone: AdminActivityTone }> = {
  ...
  ENTRY_REVISION_SUBMITTED: { label: "ارسال ویرایش", tone: "blue" },
  ENTRY_REVISION_APPROVED: { label: "تأیید ویرایش", tone: "green" },
  ENTRY_REVISION_CHANGES_REQUESTED: { label: "درخواست تغییر ویرایش", tone: "orange" },
  ENTRY_REVISION_REJECTED: { label: "رد ویرایش", tone: "red" },
  ENTRY_REVISION_CANCELLED: { label: "لغو ویرایش", tone: "neutral" },
...
function createActivityDescription(activity: AdminOverviewActivity) {
  ...
  const descriptions: Record<AdminAuditAction, string> = {
    ...
    ENTRY_REVISION_SUBMITTED: `ویرایش ${entryTitle} برای بررسی فرستاده شد.`,
    ENTRY_REVISION_APPROVED: `ویرایش ${entryTitle} تأیید و منتشر شد.`,
    ENTRY_REVISION_CHANGES_REQUESTED: `ویرایش ${entryTitle} برای اصلاح بیشتر برگشت داده شد.`,
    ENTRY_REVISION_REJECTED: `ویرایش ${entryTitle} رد شد.`,
    ENTRY_REVISION_CANCELLED: `ویرایش ${entryTitle} لغو شد.`,
