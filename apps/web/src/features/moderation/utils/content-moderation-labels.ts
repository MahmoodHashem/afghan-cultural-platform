...
const historyActionLabels: Record<string, string> = {
  ...
  ENTRY_REVISION_STARTED: "ویرایش مطلب منتشرشده آغاز شد",
  ENTRY_REVISION_REQUESTED: "اصلاح مطلب منتشرشده درخواست شد",
  ENTRY_REVISION_SUBMITTED: "ویرایش مطلب برای بررسی فرستاده شد",
  ENTRY_REVISION_APPROVED: "ویرایش مطلب تأیید شد",
  ENTRY_REVISION_CHANGES_REQUESTED: "اصلاح بیشتر برای ویرایش درخواست شد",
  ENTRY_REVISION_REJECTED: "ویرایش مطلب رد شد",
  ENTRY_REVISION_CANCELLED: "ویرایش مطلب لغو شد",
